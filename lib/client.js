...
function httpGetSync(options) {
    var observable = Rx.Observable.create(function (observer) {
        ...
        options.timeout = options.timeout == null ? 30000 : options.timeout;
...
exports.syncRequest = function (props, options) {
    var config = {};
    setConfValues(props, options, config, true).subscribe();
    return config
};

exports.asyncRequest = function (props, options, onSuccess, onFailure) {
    var config = {};
